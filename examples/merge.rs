...
fn the_merge_threaded(path_1: &str, path_2: &str, merged_path: &str) {
    ...
    let join_handle = thread::spawn(move || {
        println!(
            "On a separate THREAD about to merge '{}' and '{}' into '{}'.",
            &path_1, &path_2, merged_path
        );
        ...
        println!(
            "merged '{}' and '{}' into '{}' with duration {:?}.",
            &path_1, &path_2, merged_path, &elapsed
        );
    });
